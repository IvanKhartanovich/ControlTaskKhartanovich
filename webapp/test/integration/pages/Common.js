sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("zjblessons/ControlTaskKhartanovich/app", ".html");
		...
		return Opa5.extend("zjblessons.ControlTaskKhartanovich.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["zjblessons/ControlTaskKhartanovich/localService/mockserver"], function (mockserver) {
